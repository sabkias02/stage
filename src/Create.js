...
const Create = () => {
  ...
  const handleClick = async (e) => {
    e.preventDefault();
    try {
      await axios.post("http://localhost:8003/proposals", inputs);
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <div className="main">
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          >
            <Box component="form" className="form-wrapper-one ">
              ...
              <div className="btn-group">
                <button
                  className="btn btn-large btn-primary-alta  btn-space  mt-2 w-100 d-block"
                  type="submit"
                  data-btn="preview"
                  style={{
                ...
                <button
                  onClick={handleClick}
                  className="btn btn-large btn-primary btn-space  mt-2  w-100 d-block"
                  type="submit"
                  style={{
                    borderRadius: "10px",
